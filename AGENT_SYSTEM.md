...
- **Requirement Classification Support**: AGK sessions may help classify requirement-bearing chat as a new requirement, requirement change, clarification, decision, task request, exploration only, or note/evidence only, but classification alone does not make the result canonical.

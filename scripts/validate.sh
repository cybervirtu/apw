...
check_source_file "COMMAND_CHEATSHEET.md"
...
check_source_file "docs/DOCS_VISUAL_STYLE.md"
...
check_source_file "website/pages/get-started-flow.mdx"
check_source_file "website/pages/choose-your-profile.mdx"
check_source_file "website/pages/choose-your-project-type.mdx"
...
check_target_file "COMMAND_CHEATSHEET.md"

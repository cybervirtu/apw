...
- **Audit**: Run `/path/to/apw/scripts/validate.sh [repo-root] --profile [profile] --stack [stack]` periodically to ensure projects haven't imported massive, undocumented skills outside these curated sets.
